...
__copyright__ = "Copyright (C) 2020 octoprint - Released under terms of the AGPLv3 License"
...
def fetch_template_data(refresh=False):
	...
	templates["about"]["entries"] = dict(
		about=("About iFactory3D", dict(template="dialogs/about/about.jinja2", _div="about_about", custom_bindings=False)),
		license=("iFactory3D License", dict(template="dialogs/about/license.jinja2", _div="about_license", custom_bindings=False)),
